...
const int sleepTime = 60000;  /* Zeit in Millisekunden(Standart= 60000 == Eine Minute) zwischen den Messungen und Senden des Spannungsergebnisse*/
...
boolean start = true;               /*Erster Durchlauf mit Messung oder wenn eine Fehlerhafte Messung erfolgt ist*/
